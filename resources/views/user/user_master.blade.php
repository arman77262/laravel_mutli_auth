        ...
        <div class="wrapper">
            ...
            <header class="header_area">
                ...
                <div class="sidebar_logo">
                    <a href="index.html">
  <img src="{{asset('userback/panel/assets/images/logo.png')}}" alt="" class="img-fluid logo1">
   <img src="{{asset('userback/panel/assets/images/logo_small.png')}}" alt="" class="img-fluid logo2">
                    </a>
                </div>
